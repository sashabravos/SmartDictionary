...
extension UIViewController {
    func setMyView(_ myView: UIView, _ replaceView: UIView) {
    ...
    func showBottomSheet(_ currentViewController: UIViewController, bottomSheet: UIViewController) {
    ...
    func anyTextView(_ placeholder: String = "") -> UITextView {
    ...
    func bottomSheetTitleLabel(_ labelText: String = "") -> UILabel {
        let label = UILabel()
    ...
    func bottomSheetBigButton(title: String) -> UIButton {
        let button = UIButton()
